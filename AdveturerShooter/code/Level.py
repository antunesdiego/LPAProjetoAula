    ...
    def run(self, player_score : list[int]):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_txt(14, f'Player1 - Health: {ent.health} | Score: {ent.score}', C_GREEN, (10, 25))

                if ent.name == 'Player2':
                    self.level_txt(14, f'Player2 - Health: {ent.health} | Score: {ent.score}', C_CYAN, (10, 45))

            # texto a ser printado na tela
            self.level_txt(14, f'{self.name} - Timeout: {self.timeout / 1000 :.1f}s', C_WHITE, (10, 5))
            self.level_txt(14, f'fps: {clock.get_fps() :.0f}', C_WHITE, (10, WIN_HEIGHT - 35))
            self.level_txt(14, f'entidades: {len(self.entity_list)}', C_WHITE, (10, WIN_HEIGHT - 20))
            # Atualizar tela
            pygame.display.flip()
